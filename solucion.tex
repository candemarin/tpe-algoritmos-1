...
\pred{caminoLibre}{t: \tablero, p0: \pos, p1: \pos}{
	...
	(\exists s: \TLista{\pos})(seqEsCaminoLibre(t, s))
}

\pred{seqEsCaminoLibre}{t: \tablero, s: \TLista{\pos}}{
	|s| > 0 \yLuego s[0] = p1 \y s[|s| - 1] = p0 \y sinRepetidos(s) \y \\ seqPosValidas(t, s) \y esCamino(t, s) \y seqSinBombas(\text{tail}(s))
}
...
\pred{esCamino}{t: \tablero, s: \TLista{\pos}}{
	(\forall i: \ent)(1 \leq i < |s| \implicaLuego sonAdyacentes(t, s[i-1], s[i]))
}
...
\begin{proc}{jugarPlus}{\In t: \tablero, \In b: \banderitas, \In p : \pos, \Inout j: \jugadas}{}
	...
	\post{posEnJugadas(p, j) \y estaContenida(j_0, j) \y \\minasAdyacentes(t, p) = 0 \implica (\forall s: \TLista{\pos})(seqEsCaminoLibre(t, s) \implica seqPosEnJugadas(s, j))}
	
	\pred{estaContenida}{s: \TLista{T}, t: \TLista{T}}{
		(\forall x: T)(x \in s \implica x \in t)
	}
	
	\pred{seqPosEnJugadas}{s: \TLista{\pos},  j: \jugadas}{
		(\forall p: \pos)(p \in s \implica posEnJugadas(p, j))
	}
\end{proc}
