...
\aux{minasAdyacentes}{t: \tablero, p: \pos}{$\mathbb{Z}$}{ \sum_{i=0}^{|t|-1} \sum_{j=0}^{|t[i]|-1} \IfThenElse{\text{sonAdyacentes}(p, (i,j)) \land t[i][j]}{1}{0}}

\pred{sonAdyacentes}{p: \pos, q: \pos}{
	\text{posValida(p)} \yLuego \\ 
	\text{posValida(q)} \yLuego \\ 
	\neg (p[0] - q[0] = 0 \land p[1] - q[1] = 0) \land \\
